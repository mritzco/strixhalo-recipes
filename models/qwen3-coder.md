...
| `8b452d` | v0.1.0 | UD-Q4_K_XL | 39223.4 | 56.9 | 2 | 3 | harness-tool-use 1/1; throughput 2/2; tool-roundtrip 1/1 |
...
- 20260907T1250Z — pi harness one-shot (pi -p, provider local -> llama-swap qwen3-coder): tool loop through a real agent harness; result 42 observed. First harness-level evidence in the battery.
