...
- Verdict: validated* — 2 result(s) across 1 variant(s); 2 witness(es) at the current hash
- Confirmed capabilities: tools=True, mcp=False, vision=False · objectives: quality, agent_capability
...
|---|---|---|---|---|---|---|---|
| `d81cee` | v0.1.0 | IQ4_XS | 3329.3 | 19.0 | 2 | 2 | agent-coding 1/1; context-recall 1/1; harness-tool-use 1/1; throughput 1/1; tool-roundtrip 1/1 |
